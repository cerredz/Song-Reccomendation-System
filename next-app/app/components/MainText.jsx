...
export default function MainText({ state, setState }) {
  return (
    <main className="flex items-center justify-center min-h-[calc(100vh-120px)] px-8 relative z-10">
      <motion.div animate={{ translateY: state.started ? 0 : 150 }} layout transition={{ duration: 0.5 }} className="text-center max-w-2xl">
